    ...
    return (
      <div style={{ width: 550, margin: "50px auto" }}>
        <Tooltip
          ...
          content={
            <>
              This means that we offer the client a guaranteed trial to work
              with you for up to 8 hours on a project you spec out. As long as
              the client agrees that you adhered to{" "}
              <Link
                as="a"
                display="inline"
