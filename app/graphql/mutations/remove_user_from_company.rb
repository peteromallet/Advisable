  ...
  class RemoveUserFromCompany < Mutations::BaseMutation
    ...
    def authorized?(user_id:)
      ...
      if current_user.company_id != user.company_id
        ApiError.invalid_request("userBelongsToDifferentCompany", "This user belongs to a different company and can't be removed by you.")
    ...
    def resolve(user_id:)
      user = User.find_by!(uid: user_id)
      user.update!(company_id: nil, application_status: "Disabled")
      {success: true}
    end
  end
end
