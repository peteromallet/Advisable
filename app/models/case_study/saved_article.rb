...
module CaseStudy
  class SavedArticle < ApplicationRecord
    ...
    belongs_to :shared_by, class_name: "::User", inverse_of: :saved_sent_articles, optional: true
  end
end
...
#  index_case_study_saved_articles_on_search_id     (search_id)
#  index_case_study_saved_articles_on_shared_by_id  (shared_by_id)
