...
class Message < ApplicationRecord
  ...
  KINDS = %w[AgreementAccepted AgreementCreated AgreementDeclined InterviewRequest InterviewScheduled ConsultationRequest ConsultationDeclined system].freeze
