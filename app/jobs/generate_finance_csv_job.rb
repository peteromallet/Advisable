...
class GenerateFinanceCsvJob < ApplicationJob
  HEADERS = %w[name recipientEmail paymentReference receiverType amountNet amountGross amountVAT amountWithFee sourcingFee amountCurrency sourceCurrency targetCurrency IBAN type].freeze
