...
import {
  CandidateAttributes as StyledCandidateAttributes,
  CandidateAttribute,
...
export default function CandidateAttributes({
  rate,
  reviewsCount,
  rating,
  availability,
  ...
  return (
    <StyledCandidateAttributes compact={compact}>
      {rating && (
        <CandidateRating>
      ...
      <CandidateAttribute>
        <CandidateAttributeLabel>Available to start</CandidateAttributeLabel>
