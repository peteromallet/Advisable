...
const ProjectReference = ({ setValues, values, gotoNextStep, gotoPreviousStep }) => {
            ...
            <FieldRow>
              <React.Fragment>
                ...
                <Checkbox
                  ...
                  error={formik.touched.canContact && formik.errors.canContact}
                />
              </React.Fragment>
            </FieldRow>
            <FieldRow>
              <TextField
                ...
                error={formik.touched.contactRole && formik.errors.contactRole}
              />
            </FieldRow>
            <FieldRow>
              <TextField
