...
export default function Results({ results }) {
  ...
  return (
    <div className="w-[280px] bg-gradient-to-b from-[#0082FD] to-[#692FFF] rounded-lg p-5 pb-8">
      ...
      <div className="space-y-7">
        <div>
          <div className="flex gap-2">
            <div className="w-[28px] h-[28px]">
              <ChartBar className="stroke-white" />
            </div>
            <div className="text-white">$400,000</div>
          </div>
        ...
        <div>
          <div className="flex gap-2">
            <div className="w-[28px] h-[28px]">
              <TrendingUp className="stroke-white" />
            </div>
            <div className="text-white">145%</div>
          </div>
