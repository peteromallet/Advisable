...
export default ({ isOpen, onClose }) => (
  <Modal isOpen={isOpen} onClose={onClose} padding="xl">
    ...
    <NewProjectChoice to="/">
      ...
      <p>Have an Advisable team member setup a project with you making sure you don’t miss anything!</p>
    ...
    <NewProjectChoice to="/">
      <h4>Self-serve</h4>
      <p>Setup the project yourself without speaking to a member of the Advisable team.</p>
      <svg className="Arrow" width={7} height={11} fill="none">
        <path d="M.778 10.5l5-5-5-5" stroke="#8F96AE" />
      </svg>
    </NewProjectChoice>
