...
export default function TestimonialRequest({ id, specialistId }) {
  return (
    <div className="px-4 xl:px-6 pt-3 pb-4 xl:py-6 mb-8 bg-neutral50 rounded-[20px] xl:rounded-lg ring-neutral200 ring-1 ring-inset">
      <div className="flex gap-3 mb-5">
        <div className="w-10 h-10 p-2.5 bg-blue100 rounded-full flex items-center justify-center">
          <BadgeCheck className="fill-blue500" />
        </div>
        <div>
          <h4 className="text-base xl:text-lg text-neutral900 font-semibold tracking-tight leading-none xl:leading-5 mb-1">
