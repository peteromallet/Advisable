  ...
  return (
    <Box>
        ...
        {[1, 2, 3, 4, 5].map((num) => (
          ...
          >
            ...
            >
              ...
              alignItems="center"
            >
              <Text px="xxs" fontSize="xxs" color="neutral500">
      ...
      {/* <Box display="flex" justifyContent="center" alignItems="center">
        <Text px="xxs" mr="auto" fontSize="xxs" color="neutral200">
          not important
        </Text>
        <Text px="xxs" fontSize="xxs" color="neutral200">
          very important
        </Text>
      </Box> */}
    </Box>
