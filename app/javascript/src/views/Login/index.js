  ...
  return (
    <Box maxWidth={400} mx="auto" pt="xxl" pb="l">
      ...
      <Card py="xl" px="l">
        ...
        <Text fontSize="s" textAlign="center" color="neutral.7" mb="l">
          ...
          {(formik) => (
            <Form onSubmit={formik.handleSubmit}>
              <Box mb="s">
                ...
                <Field id="email" as={Input} name="email" placeholder="Email" />
                <ErrorMessage name="email" component={Error} mt="xs" />
              </Box>
              <Box mb="l">
                <Label mb="xs" htmlFor="password">
                  Password
                </Label>
                <Field
                  as={Input}
