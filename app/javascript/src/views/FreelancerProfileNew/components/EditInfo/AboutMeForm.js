...
// Components
import { Box, Textarea, Select, useBreakpoint } from "@advisable/donut";
...
export default function AboutMeForm({ modal, specialist }) {
    ...
    >
      <Form>
        <Box display={isWidescreen ? "flex" : null} mb="l" mt={5}>
          <Box mr={isWidescreen && "s"} mb={!isWidescreen && "l"} width="100%">
            <FormField
              name="city"
              label="City"
              width="100%"
