...
ActiveRecord::Schema.define(version: 2020_03_31_104129) do
  ...
  create_table 'application_references', force: :cascade do |t|
    ...
    t.index %w[application_id],
            name: 'index_application_references_on_application_id'
    t.index %w[project_type project_id],
            name: 'index_application_references_on_project_type_and_project_id'
    t.index %w[uid], name: 'index_application_references_on_uid'
  end
  ...
  create_table 'application_rejection_reasons', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[airtable_id],
            name: 'index_application_rejection_reasons_on_airtable_id'
  end
  ...
  create_table 'applications', force: :cascade do |t|
    ...
    t.index %w[project_id], name: 'index_applications_on_project_id'
    t.index %w[rejection_reason_id],
            name: 'index_applications_on_rejection_reason_id'
    t.index %w[specialist_id], name: 'index_applications_on_specialist_id'
  end
  ...
  create_table 'booking_rejection_reasons', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[airtable_id],
            name: 'index_booking_rejection_reasons_on_airtable_id'
  end
  ...
  create_table 'bookings', force: :cascade do |t|
    ...
    t.index %w[airtable_id], name: 'index_bookings_on_airtable_id'
    t.index %w[application_id], name: 'index_bookings_on_application_id'
    t.index %w[rejection_reason_id],
            name: 'index_bookings_on_rejection_reason_id'
  end
  ...
  create_table 'client_calls', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[airtable_id], name: 'index_client_calls_on_airtable_id'
    t.index %w[project_id], name: 'index_client_calls_on_project_id'
    t.index %w[sales_person_id], name: 'index_client_calls_on_sales_person_id'
    t.index %w[user_id], name: 'index_client_calls_on_user_id'
  end
  ...
  create_table 'client_users', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[client_id], name: 'index_client_users_on_client_id'
    t.index %w[user_id], name: 'index_client_users_on_user_id'
  end
  ...
  create_table 'clients', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.string 'domain'
    t.index %w[airtable_id], name: 'index_clients_on_airtable_id'
  end
  ...
  create_table 'consultations', force: :cascade do |t|
    ...
    t.index %w[airtable_id], name: 'index_consultations_on_airtable_id'
    t.index %w[interview_id], name: 'index_consultations_on_interview_id'
    t.index %w[search_id], name: 'index_consultations_on_search_id'
    t.index %w[skill_id], name: 'index_consultations_on_skill_id'
    t.index %w[specialist_id], name: 'index_consultations_on_specialist_id'
    t.index %w[uid], name: 'index_consultations_on_uid'
    t.index %w[user_id], name: 'index_consultations_on_user_id'
  end
  ...
  create_table 'featured_specialist_contents', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[airtable_id],
            name: 'index_featured_specialist_contents_on_airtable_id'
  end
  ...
  create_table 'industries', force: :cascade do |t|
    ...
    t.string 'airtable_id'
    t.string 'color'
    t.index %w[uid], name: 'index_industries_on_uid'
  end
  ...
  create_table 'interviews', force: :cascade do |t|
    ...
    t.index %w[airtable_id], name: 'index_interviews_on_airtable_id'
    t.index %w[application_id], name: 'index_interviews_on_application_id'
    t.index %w[user_id], name: 'index_interviews_on_user_id'
  end
  ...
  create_table 'matches', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.string 'status'
    t.index %w[project_id], name: 'index_matches_on_project_id'
    t.index %w[specialist_id], name: 'index_matches_on_specialist_id'
  end
  ...
  create_table 'off_platform_projects', force: :cascade do |t|
    ...
    t.bigint 'application_id'
    t.index %w[airtable_id], name: 'index_off_platform_projects_on_airtable_id'
    t.index %w[application_id],
            name: 'index_off_platform_projects_on_application_id'
    t.index %w[specialist_id],
            name: 'index_off_platform_projects_on_specialist_id'
  end
  ...
  create_table 'payments', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[charge_id], name: 'index_payments_on_charge_id'
    t.index %w[project_id], name: 'index_payments_on_project_id'
    t.index %w[source_id], name: 'index_payments_on_source_id'
    t.index %w[uid], name: 'index_payments_on_uid'
  end
  ...
  create_table 'project_industries', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[industry_id], name: 'index_project_industries_on_industry_id'
    t.index %w[project_type project_id],
            name: 'index_project_industries_on_project_type_and_project_id'
  end
  ...
  create_table 'project_skills', force: :cascade do |t|
    ...
    t.boolean 'primary'
    t.index %w[project_type project_id],
            name: 'index_project_skills_on_project_type_and_project_id'
    t.index %w[skill_id], name: 'index_project_skills_on_skill_id'
  end
  ...
  create_table 'projects', force: :cascade do |t|
    ...
    t.index %w[client_id], name: 'index_projects_on_client_id'
  ...
  create_table 'reviews', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[airtable_id], name: 'index_reviews_on_airtable_id'
    t.index %w[project_type project_id],
            name: 'index_reviews_on_project_type_and_project_id'
    t.index %w[reviewable_type reviewable_id],
            name: 'index_reviews_on_reviewable_type_and_reviewable_id'
    t.index %w[specialist_id], name: 'index_reviews_on_specialist_id'
  end
  ...
  create_table 'searches', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[recommended_project_id],
            name: 'index_searches_on_recommended_project_id'
    t.index %w[uid], name: 'index_searches_on_uid'
  ...
  create_table 'skills', force: :cascade do |t|
    ...
    t.index %w[original_id], name: 'index_skills_on_original_id'
  end
  ...
  create_table 'specialist_skills', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[skill_id], name: 'index_specialist_skills_on_skill_id'
    t.index %w[specialist_id], name: 'index_specialist_skills_on_specialist_id'
  end
  ...
  create_table 'specialists', force: :cascade do |t|
    ...
    t.index %w[country_id], name: 'index_specialists_on_country_id'
  end
  ...
  create_table 'tasks', force: :cascade do |t|
    ...
    t.index %w[airtable_id], name: 'index_tasks_on_airtable_id'
    t.index %w[application_id], name: 'index_tasks_on_application_id'
    t.index %w[uid], name: 'index_tasks_on_uid'
  end
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.index %w[airtable_id], name: 'index_users_on_airtable_id'
    t.index %w[country_id], name: 'index_users_on_country_id'
    t.index %w[industry_id], name: 'index_users_on_industry_id'
  end
